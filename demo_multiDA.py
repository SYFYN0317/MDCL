...
parser.add_argument('--factor_lambda', choices=[0, 0.001, 0.01, 0.1, 1], default=1, help='number of classes')
parser.add_argument('--batch_size', type=int, default=36, help='number of batch')
parser.add_argument('--patch_size', type=int, default=7, help='size of patch')
...
def experiment():
    ...
    print("OA: {:.2f} | AA: {:.2f} | Kappa: {:.4f}".format(OA * 100, AA * 100, Kappa))
    print("CA: ", CA * 100)
    toc = time.time()
    time_all = toc - tic1
